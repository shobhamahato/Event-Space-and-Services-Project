...
if(isset($_POST['submit'])){
    ...
    // CARD DETAILS
    // ==========================
    $card_types = isset($_POST['card_types']) 
        ? implode(",", $_POST['card_types']) 
        : "";
    ...
    if($vendor_stmt->execute()){
        ...
        if($card_stmt->execute()){
            ...
            echo "Cards Table Error : " . $card_stmt->error;
        }
        ...
        echo "Vendor Table Error : " . $vendor_stmt->error;
    }
...
name="printing_types"
class="form-control mb-3"
placeholder="Printing Types (Digital / Offset / Laser)">

<input type="text"
name="paper_types"
class="form-control mb-3"
placeholder="Paper Types (Matte / Glossy / Handmade)">

<textarea
name="packages"
class="form-control mb-3"
placeholder="Packages Details"></textarea>
...
name="about_business"
class="form-control mb-3"
placeholder="About Business"></textarea>
