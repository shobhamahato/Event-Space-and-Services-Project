...
$vendor_type = strtolower($_POST['vendor_type']);
...
if($vendor_type == "caterer"){
    ...
    $plate_count = $_POST['count'];

    $final_amount = $service_price * $plate_count;
}

/* BEAUTY */

elseif($vendor_type == "beauty"){

    $beauty_person = $_POST['beauty_person'];

    $final_amount = $service_price * $beauty_person;
}

/* CARDS */

elseif($vendor_type == "cards"){

    $card_count = $_POST['card_count'];

    $final_amount = $service_price * $card_count;
}
